...
public class YnTaskController extends SqBaseController
{
    private static final String ENTITY = "ynTask";
    ...
    @Operation(summary = "旧系统兼容接口 POST /todo")
    @PostMapping("/todo")
    public AjaxResult post1_todo(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "todo", params, body, pathVars);
    }

    @Operation(summary = "旧系统兼容接口 GET /end")
    @GetMapping("/end")
    public AjaxResult get2_end(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "end", params, body, pathVars);
    }
