...
public class YnWxDeptController extends SqBaseController
{
    private static final String ENTITY = "ynWxDept";
    ...
    @Operation(summary = "旧系统兼容接口 GET /all")
    @GetMapping("/all")
    public AjaxResult get1_all(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "all", params, body, pathVars);
    }

    @Operation(summary = "旧系统兼容接口 POST /superior")
    @PostMapping("/superior")
    public AjaxResult post2_superior(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "superior", params, body, pathVars);
    }
