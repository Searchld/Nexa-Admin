...
public class CarsOutLogsController extends SqBaseController
{
    private static final String ENTITY = "carsOutLogs";
    ...
    @PostMapping("/save")
    public AjaxResult post1_save(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
    ...
    @PostMapping("/update")
    public AjaxResult post2_update(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
