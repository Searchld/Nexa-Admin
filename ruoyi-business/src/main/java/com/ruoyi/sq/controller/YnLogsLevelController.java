...
public class YnLogsLevelController extends SqBaseController
{
    private static final String ENTITY = "ynLogsLevel";
    ...
    @Operation(summary = "旧系统兼容接口 GET /chart/count")
    @GetMapping("/chart/count")
    public AjaxResult get1_chart_count(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "chart_count", params, body, pathVars);
    }
