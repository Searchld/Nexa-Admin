...
public class CarsController extends SqBaseController
{
    private static final String ENTITY = "cars";
    ...
    @Operation(summary = "旧系统兼容接口 POST /import")
    @PostMapping("/import")
    public AjaxResult post1_import(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "import", params, body, pathVars);
    }

    @Operation(summary = "旧系统兼容接口 GET /select")
    @GetMapping("/select")
    public AjaxResult get2_select(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "select", params, body, pathVars);
    }
