...
public class AlertReasonController extends SqBaseController
{
    private static final String ENTITY = "alertReason";
    ...
    @Operation(summary = "旧系统兼容接口 PUT /update/all")
    @PutMapping("/update/all")
    public AjaxResult put1_update_all(@PathVariable(required = false) Map<String, String> pathVars, @RequestParam(required = false) Map<String, Object> params, @RequestBody(required = false) Map<String, Object> body)
    {
        return specialEntity(ENTITY, "update_all", params, body, pathVars);
    }
