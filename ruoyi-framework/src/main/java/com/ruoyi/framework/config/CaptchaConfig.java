...
public class CaptchaConfig
{
    ...
    public DefaultKaptcha getKaptchaBean()
    {
        ...
        properties.setProperty(KAPTCHA_TEXTPRODUCER_FONT_COLOR, "61,126,255");
        // 验证码图片宽度 默认为200
        ...
        // 彩色字符和轻量干扰线，保持登录页验证码清晰易读
        properties.setProperty(KAPTCHA_WORDRENDERER_IMPL, "com.ruoyi.framework.config.ColorfulWordRenderer");
