...
public class SysLoginService
{
    ...
    public void loginPreCheck(String username, String password)
    {
        ...
        // 密码如果不在指定范围内 错误
        int passwordMinLength = configService.selectConfigInt("security.password-min-length", UserConstants.PASSWORD_MIN_LENGTH);
        int passwordMaxLength = configService.selectConfigInt("security.password-max-length", UserConstants.PASSWORD_MAX_LENGTH);
