...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    {
        if (StringUtils.isNull(dept.getParentId()) || dept.getParentId() == 0L)
        {
            dept.setParentId(0L);
            dept.setAncestors("0");
    ...
    public int updateDept(SysDept dept)
    {
        ...
        if (StringUtils.isNotNull(oldDept) && (StringUtils.isNull(dept.getParentId()) || dept.getParentId() == 0L))
        {
            String oldAncestors = oldDept.getAncestors();
            dept.setParentId(0L);
            dept.setAncestors("0");
            updateDeptChildren(dept.getDeptId(), "0", oldAncestors);
        }
