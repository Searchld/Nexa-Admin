 ...
 * 阅读器 device_reader
 */
public class DeviceReader extends BaseEntity
{
    ...
    @NotBlank(message = "阅读器名称不能为空")
    @Size(max = 100, message = "阅读器名称不能超过100个字符")
    ...
    @NotBlank(message = "阅读器编码不能为空")
    @Size(max = 64, message = "阅读器编码不能超过64个字符")
