<template>
  <div class="art-full-height">
    <SystemCrudPage
      title="入料离线记录"
      permission="business:feedOfflineLog"
      id-key="id"
      :fields="fields"
      :list-fn="fetchSqFeedOfflineLogList"
      :get-fn="fetchSqFeedOfflineLog"
      :add-fn="addSqFeedOfflineLog"
      :update-fn="updateSqFeedOfflineLog"
      :remove-fn="removeSqFeedOfflineLog"
      :defaults="{ isDeleted: '0', status: '0', yiwu: '无', bigs: '无', cars: '自卸车' }"
      export-url="/business/sq/feed-offline-log/export"
      drawer-size="900px"
    />
  </div>
</template>
...
<script setup lang="ts">
  ...
  import {
    addSqFeedOfflineLog,
    fetchSqChuteOptions,
    fetchSqFeedOfflineLog,
    fetchSqFeedOfflineLogList,
    removeSqFeedOfflineLog,
    updateSqFeedOfflineLog
  } from '@/api/business/sqRecord'

  defineOptions({ name: 'BusinessSqFeedOfflineLog' })
  ...
  const fields = computed(() => [
    ...
    { prop: 'status', label: '状态', search: true, width: 90 },
    ...
    { prop: 'imgpath1', label: '图片地址1', span: 24, minWidth: 160 },
    {
      prop: 'beginTime',
      label: '开始时间',
      type: 'datetime',
